...
import AdminDashboardModular from "./components/admin/AdminDashboard.jsx";
import AdminProductsModular from "./components/admin/AdminProducts.jsx";
import AdminCustomersModular from "./components/admin/AdminCustomers.jsx";
import AdminInventoryModular from "./components/admin/AdminInventory.jsx";
import AdminFinanceModular from "./components/admin/AdminFinance.jsx";
import AdminReportsModular from "./components/admin/AdminReports.jsx";
import AdminPromosModular from "./components/admin/AdminPromos.jsx";
import AdminUsersModular from "./components/admin/AdminUsers.jsx";
import AdminCategoriesModular from "./components/admin/AdminCategories.jsx";
import AdminIntegrationsModular from "./components/admin/AdminIntegrations.jsx";
import AdminPaymentsCardModular from "./components/admin/AdminPaymentsCard.jsx";
import AdminPrinterCardModular from "./components/admin/AdminPrinterCard.jsx";
import AdminStoreCardModular from "./components/admin/AdminStoreCard.jsx";
import AdminModalitiesCardModular from "./components/admin/AdminModalitiesCard.jsx";
import AdminCashRegisterModular from "./components/admin/AdminCashRegister.jsx";
import AdminAppModular from "./components/admin/AdminApp.jsx";
...
function TrackScreen({ order, store, now }) {
  return <TrackScreenModular order={order} store={store} now={now} />;
}
...
function AdminDashboard({ store, now, setSec }) {
  return <AdminDashboardModular store={store} now={now} setSec={setSec} />;
}
...
function AdminCustomers({ store }) {
  return <AdminCustomersModular store={store} />;
}
...
function AdminPaymentsCard({ store }) {
  return <AdminPaymentsCardModular store={store} />;
}
...
function AdminTables({ store, now }) {
  return <AdminTablesModular store={store} now={now} />;
}

function AdminCashRegister({ store, now }) {
  return <AdminCashRegisterModular store={store} now={now} />;
}
